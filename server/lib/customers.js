...
exports.getOrCreateCustomer = exports.listPaymentMethod = exports.createSetupIntent = void 0;
const _1 = require(".");
 ...
 */
async function listPaymentMethod(userId) {
    const customer = await getOrCreateCustomer(userId);
...
exports.listPaymentMethod = listPaymentMethod;
/**
